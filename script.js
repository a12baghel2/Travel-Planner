onload = function() {
    ...
    const cities = ['Delhi','Mumbai','Gujrat','Goa','Kanpur','Jammu','Hyderabad','Banglore','Gangtok','Meghalaya'];
        ...
        for(let i=1;i=V/2;){
            ...
            if(n1 !== n2){
                ...
                for(let j=0;j<edges.length;j++){
                    if(edges[j]['from'] === n1 && edges[j]['to'] === n1){
                ...
                if(works <= 1){
                    if(works === 0 && i < V/4){
                        ...
                        edges.push({
                            ...
                            to: n2,
                            color: 'green',
                            label: String(Math.floor(Math.random()*50)+31),
                        })
                    }
                    i++;
                }
    ...
    getNew.onclick = function() {
        ...
        temptext2.innerText = "Find least time path to "+cities[src-1]+' to '+cities[dst-1];
        temptext.style.display = "inline";
        temptext2.style.display = "inline";
        container2.style.display = "none";
    };

    solve.onlcick = function( ){
